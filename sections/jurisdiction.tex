...
\begin{enumerate}
    ...
    \item \textbf{FRCP 4(k)} governs in personam jurisdiction.
...
\subsubsection{``Notice Reasonably Calculated'' \emph{Mullane v. Central Hanover Bank \& Trust}}
...
\begin{enumerate}
    ...
    sponte} (as the Supreme Court did in ) %TODO)
...
\begin{enumerate}
    ...
    create personal jurisdiction where none otherwise exists.}
