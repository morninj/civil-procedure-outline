    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                rule. Otherwise, apply the federal rule. (To hold otherwise 
                would ``disembowel'' Article III or the REA. Casebook p. 523.)
            \end{itemize}
        \end{enumerate}
        \begin{enumerate}
            \item Judge-made rule (``\emph{Hanna} dictum''):
            \begin{itemize}
                \item Is the difference between the state and federal rules 
                \textbf{outcome determinative}? If not, apply the federal 
                rule. If yes:
